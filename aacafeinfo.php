							...
							<ul class="menu-box">
								...
								<li>
									<a href="http://fresho.dothome.co.kr/aatest.html">
										<img class="menu" id="check" src="main(image)/cafe.png" alt="cafe"/>
									</a>
								</li>
								<li>
			...
			<script type="text/javascript">
                function plus() {
							...
							function count(){
									...
									var n = Number(td.innerHTML);
									if(n>0){
									location.href = "basket_ok.php?no=<?php echo $shopinfo['no'];?> & var="+n;
								}
									else{
										window.alert('1개 이상 선택해주세요.')
										n.getElementById('test').value='';
                            ...
                            function buy(){
									...
									var n = Number(td.innerHTML);
									if(n>0){
									location.href = "buy.php?no=<?php echo $shopinfo['no'];?> & var="+n;
								}
									else{
										window.alert('1개 이상 선택해주세요.')
										n.getElementById('test').value='';
					...
					<div id="shop_p_info">
						...
						<div id="shop_icon">
							<ul>
								...
								<li><a onclick="count()"><img src="list(image)/basket.png" alt="" title="" /></a></li>
							</ul>
						</div>
                        <?php
